    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-poppins font-black mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {whyChooseUs.map((item, i) => (
              <Card key={i} className="card-gradient border-glow p-6 text-center scale-hover group">
                ...
                <h3 className="text-lg font-poppins font-bold text-foreground mb-2">{item.title}</h3>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-8">
            <Link to="/services">
              <Button variant="cta" className="group text-base">
                View All Services
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Button>
            </Link>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-secondary/20">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-base text-muted-foreground">Weekly group class timetable</p>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border">
                  <th className="text-left py-3 px-4 font-poppins font-semibold text-muted-foreground">Time</th>
                  {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((d) => (
                    <th key={d} className="text-center py-3 px-3 font-poppins font-semibold text-foreground">{d}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {schedule.map((row, i) => (
                  <tr key={i} className="border-b border-border/50 hover:bg-muted/30 transition-colors">
                    ...
                    {[row.mon, row.tue, row.wed, row.thu, row.fri, row.sat, row.sun].map((cls, j) => (
                      <td key={j} className="text-center py-3 px-3 text-muted-foreground">
                        {cls === "—" ? (
                          <span className="text-border">—</span>
                        ) : (
                          <span className="bg-primary/10 text-primary px-2 py-1 rounded text-xs">{cls}</span>
                        )}
                      </td>
                    ))}
                  </tr>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              <Card key={i} className="card-gradient border-glow p-6 scale-hover">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-secondary/20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-base text-muted-foreground">Conveniently located in Haramaya, Ethiopia</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-5">
              ...
              <Link to="/contact">
                <Button variant="hero" className="w-full mt-3 text-base">
                  Get Directions
                </Button>
              </Link>
            </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-primary/10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/contact">
              <Button variant="glass" size="xl" className="px-10 text-lg">
                Contact Us
              </Button>
            </Link>
          </div>
